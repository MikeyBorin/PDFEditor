...
public class ToolbarSettingsService
{
    ...
    private void Load()
    {
        ...
        else
        {
            ...
            var newlyAdded = new[] { "Pan", "Tick", "Cross", "RectangleFilled", "EllipseFilled", "TextGroup", "ShapeGroup" };
            bool changed = false;
    ...
    public static readonly string[] AllCommandIds = new[]
    {
        ...
        // Tools
        "Select", "Pan", "Highlight", "StickyNote", "TextGroup", "ShapeGroup", "Whiteout", "Erase",
